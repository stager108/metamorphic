...
./experiment1.2/generate_mut.exe ${GENOME} ${TESTDIR}/general_config.txt -${MODE}
python3 experiment1.2/generate_pack.py ${TESTDIR}/general_config.txt.inner ${TESTDIR}/${TESTPREFIX} $N
