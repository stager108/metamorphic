...
./experiment2/run_iss_bwa.sh ${TESTDIR} ${GENOME} aligned 50 ${GENOME}
./experiment2/run_iss_bwa.sh ${TESTDIR} ${GENOME} mutated 50 ${GENOME}
./experiment2/run_iss_bwa.sh ${TESTDIR} ${GENOME} donor 50 ${GENOME}
...
do
  ...
  ./experiment2/run_surg_copy.sh ${TESTDIR} mutated ${TESTPREFIX}0${i}c ${TESTDIR}/${TESTPREFIX}_sv0${i}.txt ${TESTPREFIX} ${GENOME} ${TESTDIR}/donor.bam
  ./experiment2/run_surg_ind.sh ${TESTDIR} ${TESTPREFIX}0${i}c ${TESTPREFIX}0${i} ${TESTDIR}/${TESTPREFIX}_ind0${i}.txt ${TESTPREFIX} ${GENOME}
  ...
  ./experiment2/run_strelka.sh ${TESTDIR} aligned mutated_${MODE}${i} ${TESTPREFIX}0${i} ${GENOME}
