...
addindel.py -v ./bamsurgeon/test_data/test_indels.txt -f  ./bamsurgeon/test_data/testregion_realign.bam -r $REF -o ./bamsurgeon/test_data/testregion_mut.bam  --picardjar $1 --aligner mem --seed 1234
